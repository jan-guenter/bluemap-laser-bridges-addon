...
package io.github.janguenter.bluemap.laserbridges;

import io.github.janguenter.bluemap.laserbridges.adapter.bluemap522.AdapterCompatibility;

import java.lang.reflect.InvocationTargetException;
import java.lang.reflect.Method;

/** BlueMap add-on entrypoint installed before resource-pack construction. */
public final class BlueMapLaserBridgesAddon implements Runnable {
    ...
    public void run() {
        try {
            ...
            Class<?> adapter = Class.forName(
                    "io.github.janguenter.bluemap.laserbridges.adapter.bluemap522.BlueMap522Adapter",
                    true,
                    BlueMapLaserBridgesAddon.class.getClassLoader()
            );
    ...
    private static void inactive(String reason, Throwable cause) {
        ...
        System.err.println("BlueMap Laser Bridges & Doors add-on is inactive: "
                + reason + detail + '.');
    }
}
